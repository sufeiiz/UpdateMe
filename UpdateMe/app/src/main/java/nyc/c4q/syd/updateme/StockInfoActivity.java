...
public class StockInfoActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
         stockSymbol = i.getStringExtra(MainActivity.STOCK_SYMBOL);
        initializeViews();
    ...
    private class MyAsyncTask extends AsyncTask<String, String, String>{
        ...
        private StockInfo getStockInformation(Element entry){
            ...
            StockInfo theStock = new StockInfo(stockLastTradePrice, stockYearLow, stockDaysHigh, stockDaysLow, stockName, stockYearHigh, stockDaysRage, stockChange);
